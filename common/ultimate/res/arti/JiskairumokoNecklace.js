module.exports = {
  ...
  dogmaBiscuit: `k`,
  dogma: [
    `I compel you to return a card from your score pile! if you do, transfer an achievement of the same value from your achievements to mine, and junk all cards in the deck of that value!`
  ],
  dogmaImpl: [
    (game, player, { leader }) => {
