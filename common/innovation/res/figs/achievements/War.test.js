...
test('War', () => {
  ...
  expect(t.cards(game, 'purple', 'dennis')).toEqual(['Education'])
  expect(t.cards(game, 'yellow', 'micah')).toEqual(['Medicine'])
  expect(t.cards(game, 'blue', 'micah')).toEqual(['Mathematics', 'Alchemy'])
  expect(t.cards(game, 'red', 'scott')).toEqual([])
  expect(t.cards(game, 'green', 'scott')).toEqual(['Databases'])
})
