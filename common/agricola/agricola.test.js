...
describe('Agricola', () => {
  ...
  describe('card sets', () => {
    ...
    test('getCardSetIds returns all set IDs', () => {
      expect(res.getCardSetIds()).toEqual(['baseA', 'baseB', 'minorA', 'minorB', 'minorC', 'minorD', 'minorE'])
    })
    ...
    test('game defaults to all card sets', () => {
      ...
      expect(game.settings.cardSets).toEqual(['baseA', 'baseB', 'minorA', 'minorB', 'minorC', 'minorD', 'minorE'])
    })
  })
