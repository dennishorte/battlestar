module.exports = {
  ...
  actionSpaceId: 'forest-owner',
  ownerOnly: false,
  onActionSpaceUsed(game, player, owner) {
    if (player.name === owner.name) {
      ...
      game.log.add({
        template: '{player} gets 3 wood, {playerOwner} gets 1 wood from {card}',
        args: { player, playerOwner: owner , card: this},
      })
    }
  },
}
