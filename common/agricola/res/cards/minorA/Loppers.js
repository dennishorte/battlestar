module.exports = {
  ...
  matches_onBuildFences(_game, player) {
    return player.wood >= 1 && player.getFencesInSupply() >= 1
  },
  onBuildFences(game, player) {
    ...
    if (selection[0] !== 'Skip') {
      ...
      game.log.add({
        template: '{player} exchanges 1 wood and 1 fence for 2 food and 1 bonus point',
        args: { player },
      })
    }
  },
